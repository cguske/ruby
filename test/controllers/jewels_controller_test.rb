...
class JewelsControllerTest < ActionController::TestCase
  ...
  test "should create jewel" do
    assert_difference('Jewel.count') do
      post :create, jewel: { description: @jewel.description, name: @jewel.name, picture: @jewel.picture, price: @jewel.price, quantity: @jewel.quantity, store_id: @jewel.store_id }
    end
  ...
  test "should update jewel" do
    patch :update, id: @jewel, jewel: { description: @jewel.description, name: @jewel.name, picture: @jewel.picture, price: @jewel.price, quantity: @jewel.quantity, store_id: @jewel.store_id }
    assert_redirected_to jewel_path(assigns(:jewel))
  end
